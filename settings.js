...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "SZRmQDSY#TaY4GBE71c1vlN9gUdiBW6AkJqoUNt-o4z-v22VgFOI", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "989136100021",
DEV: process.env.DEV || "989136100021",
